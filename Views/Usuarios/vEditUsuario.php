    ...
    <div class="container"> 
        ...
        <div class="container"> 
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="contrasena" name="contrasena" value="<?= $usuarioId->contrasena ?>" readonly>
            </div>
            <div class="form-group">
                <label class="label" for="tipo"><h4>Tipo de Usuario</h4></label>
                <select class="form-control" id="tipo" name="tipo">
                    <?php foreach ($listaTipoUsuario as $tipoUsuario) { ?>
                        <option value="<?= $tipoUsuario->id ?>" <?php if ($tipoUsuario->id == $usuarioId->tipoUsuarioId){ ?>
                            selected <?php } ?>
